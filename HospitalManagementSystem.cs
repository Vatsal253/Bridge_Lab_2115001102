...
namespace HospitalPatientManagement
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            {
                new InPatient(1, "Abhinn Ahlawatt", 45, "Appendicitis", 5, 1500),
                new OutPatient(2, "Shivansh Srivastava", 30, "Flu", 200)
            };
            ...
            foreach (Patient patient in patients)
            {
                ...
                {
                    medicalRecordPatient.AddRecord("Initial diagnosis recorded.");
                    Console.WriteLine("Medical Records: " + medicalRecordPatient.ViewRecords());
                }
