...
public class Program12
{
    public static void Main(string[] args)
    {
        ...
        InvokeWithCaching(computation, nameof(computation.Compute), new object[] { 2, 3 }); // Computed
        InvokeWithCaching(computation, nameof(computation.Compute), new object[] { 2, 3 }); // Cached
        InvokeWithCaching(computation, nameof(computation.Compute), new object[] { 3, 2 }); // Computed
        InvokeWithCaching(computation, nameof(computation.Compute), new object[] { 2, 3 }); // Cached
    }
